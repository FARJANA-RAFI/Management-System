        ...
        <div class="container text-white mt-4 mb-5">
            <div class="row">
                <div class="col-md-10 offset-md-1 font-weight-bold">
                    ...
                    <form action="<?php echo e(URL::to('add_student')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> </span>
    ...
    </div><?php /**PATH C:\xampp\htdocs\SD_final_project\sd_final_rjns\resources\views/pages/auth/user_registration.blade.php ENDPATH**/ ?>