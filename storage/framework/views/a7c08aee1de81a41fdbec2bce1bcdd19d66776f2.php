        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    ...
                    <a class="btn btn-info" href="<?php echo e(URL::to('add_session')); ?>">Add Session</a>
                </div>
                ...
                <table class="table table-dark text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success" href="<?php echo e(URL::to('edit_session/'.$s->id)); ?>">Edit</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="<?php echo e(URL::to('delete_session/'.$s->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SD_final_project\sd_final_rjns\resources\views/admin/session.blade.php ENDPATH**/ ?>